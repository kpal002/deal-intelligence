...
HAIKU_MODEL_ID: str = os.environ.get("DEALINTEL_HAIKU_MODEL", "claude-haiku-4-5-20251001")

#: Capable model for structured fact extraction.
SONNET_MODEL_ID: str = os.environ.get("DEALINTEL_SONNET_MODEL", "claude-sonnet-4-6")
...
class Settings:
    ...
    database_url: str = field(
        default_factory=lambda: os.environ.get(
            "DATABASE_URL",
            "postgresql+psycopg://dealintel:dealintel@localhost:5432/dealintel",
        )
    )
