...
from simpero.database import session_scope
from simpero.mandates import load_mandate_from_yaml
from simpero.models.audit import AuditEventType
from simpero.models.scoring import ScoreResult
from simpero.persistence import load_entity_names, load_facts, load_latest_score
from simpero.pipeline.audit import record_event
from simpero.retrieval import QueryResponse, query_facts

logger = logging.getLogger(__name__)

app = FastAPI(
    title="Simpero Deal Intelligence API",
    description=(
...
def _load_default_mandate():
    ...
    Returns:
        A :class:`~simpero.models.mandate.Mandate` or ``None`` when the sample
