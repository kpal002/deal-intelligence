...
from simpero.config import Settings, estimate_cost_usd, get_settings
...
class LLMClient:
    ...
    def classify(self, system: str, prompt: str) -> LLMResult:
        ...
        """
        from simpero.config import HAIKU_MAX_TOKENS
    ...
    def extract(self, system: str, prompt: str) -> LLMResult:
        ...
        """
        from simpero.config import SONNET_MAX_TOKENS
